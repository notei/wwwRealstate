...
class Propiedades extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_tipo_propiedad', 'id_persona_contacto', 'id_estado_propiedad', 'id_usuario', 'txt_token'], 'required'],
            [['id_tipo_propiedad', 'id_persona_contacto', 'id_estado_propiedad', 'id_usuario', 'b_publicada', 'b_pausada'], 'integer'],
    ...
    {
        return $this->hasMany(MediosContactos::className(), ['id_propiedad' => 'id_propiedad']);
    }
