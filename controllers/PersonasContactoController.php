...
use app\models\PersonasContactoSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * PersonasContactoController implements the CRUD actions for PersonasContactos model.
 */
class PersonasContactoController extends Controller
{
    ...
    {
        $searchModel = new PersonasContactoSearch();
