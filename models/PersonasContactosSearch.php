...
/**
 * PersonasContactosSearch represents the model behind the search form about `app\models\PersonasContactos`.
 */
class PersonasContactosSearch extends PersonasContactos
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id_persona_contacto', 'id_usuario'], 'integer'],
